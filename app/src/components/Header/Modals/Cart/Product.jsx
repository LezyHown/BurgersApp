...
export default function Product({ product }) {
  ...
  return (
    <motion.div className=" px-2 py-4 drop-shadow-md" {...showAnimations.productScrollSlide()}>
        ...
        <AnimatePresence>
          <div className="cart-items-price">
            ...
            <div className="out-price">
              ...
              <motion.span className="money-text" {...CounterAnimations.blinkCounter(outPrice)}>
                {currency + outPrice}
              </motion.span>
            </div>
          </div>
